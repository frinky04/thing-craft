...
public class SoundSystem {
        ...
        if (linkedList != null) {
            ...
            while (listIterator.hasNext()) {
                ...
                try {
                    ...
                    this.logger.printExceptionMessage(soundSystemException2, 1);
                }
            }
        }
        try {
    ...
    public void cleanup() {
        ...
        if (!i) {
            for (int j = 0; j < 50 && this.commandThread.alive(); ++j) {
                SoundSystem.snooze(100L);
            }
        }
        if (i || this.commandThread.alive()) {
        ...
        synchronized (object) {
            try {
                ...
                try {
                    ...
                    SoundSystem.lastException(true, soundSystemException2);
                    SoundSystem.initialized(true, true);
                    throw soundSystemException2;
                }
                ...
                if (i) {
                    ...
                    midiChannel = new MidiChannel(j, string, filenameURL);
    ...
    public boolean newLibrary(Class class_) {
        ...
        SoundSystemException soundSystemException2 = SoundSystem.lastException(false, null);
        if (soundSystemException2 != null) {
            throw soundSystemException2;
        }
        return true;
    }
            ...
            try {
                if (commandObject == null) {
                    ...
                    while (this.sourcePlayList != null && this.sourcePlayList.size() > 0) {
                        ...
                        if (commandObject3 == null) continue;
    ...
    public static boolean libraryCompatible(Class class_) {
        ...
        boolean i = SoundSystemConfig.libraryCompatible(class_);
        if (i) {
