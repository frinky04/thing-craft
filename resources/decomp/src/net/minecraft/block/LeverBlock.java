...
extends Block {
    protected LeverBlock(int id, int sprite) {
    ...
    public void onAdded(World world, int x, int y, int z) {
        if (world.isSolidBlock(x - 1, y, z)) {
            ...
            world.setBlockMetadata(x, y, z, 5 + world.random.nextInt(2));
        }
    ...
    public boolean use(World world, int x, int y, int z, PlayerEntity player) {
        ...
        world.playSound((double)x + 0.5, (double)y + 0.5, (double)z + 0.5, "random.click", 0.3f, k > 0 ? 0.6f : 0.5f);
