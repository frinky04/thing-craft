...
extends Particle {
    ...
    public RedstoneParticle(World world, double x, double y, double z) {
        this(world, x, y, z, 1.0f);
    }

    public RedstoneParticle(World world, double x, double y, double z, float scale) {
        super(world, x, y, z, 0.0, 0.0, 0.0);
        this.velocityX *= (double)0.1f;
        this.velocityY *= (double)0.1f;
        this.velocityZ *= (double)0.1f;
        this.red = (float)(Math.random() * (double)0.3f) + 0.7f;
        this.green = this.blue = (float)(Math.random() * (double)0.1f);
        this.size *= 0.75f;
        this.size *= scale;
