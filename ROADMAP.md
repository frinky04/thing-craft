...
- M7 survival follow-up (phase 2) advanced: death now enters a manual-respawn state (`R` after death timer) with HUD fade overlay, and hotbar item rendering now approximates Alpha's item path with mini 3-face block icons for solid blocks.
