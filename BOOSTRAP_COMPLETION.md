...
- [x] Item pickup added: AABB overlap test between player and dropped items during fixed tick; items with expired pickup delay (10 ticks) are collected into the hotbar and despawned.
