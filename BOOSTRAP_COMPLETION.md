...
- [x] First-person hand/item render path added: dedicated post-world render pass now draws Alpha-style held block and empty-hand right-arm geometry with ItemInHandRenderer-equivalent equip/swing transforms, player-position brightness sampling, and skin-texture sampling from `mob/char.png`.
