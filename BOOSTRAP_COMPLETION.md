...
- [x] Item pickup added: AABB overlap test between player and dropped items during fixed tick; items with expired pickup delay (10 ticks) are merged into player inventory stacks and despawned.
